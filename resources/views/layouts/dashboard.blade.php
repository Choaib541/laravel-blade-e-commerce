...
<head>
    ...
    <link rel="shortcut icon" href={{ url('assets/site_images/peace.svg') }}>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href={{ route('home') }}>
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src={{ url('assets/site_images/peace.svg') }} alt="">
                </div>
            ...
            <li class="{{ 'nav-item ' . (Request::segment(2) === 'products' ? 'active' : '') }}">
                <a class={{ 'nav-link ' . (Request::segment(2) === 'products' ? ' ' : 'collapsed') }} href="#"
                    data-toggle="collapse" data-target="#collapseTwo"
                    aria-expanded={{ Request::segment(2) === 'products' ? 'true' : 'false' }}
                    aria-controls="collapseTwo">
                    <i class="fas fa-solid fa-cart-arrow-down"></i>
                    <span>Products</span>
                </a>
                <div id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionSidebar"
                    class="{{ 'collapse ' . (Request::segment(2) === 'products' ? 'show' : '') }}">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href={{ route('dashboard.products.edit') }}>Update Product</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider my-0" />
            <li class="{{ 'nav-item ' . (Request::segment(2) === 'categories' ? 'active' : '') }}">
                <a class="{{ 'nav-link ' . (Request::segment(2) === 'categories' ? ' ' : 'collapsed') }}"
                ...
                <div id="collapseThree"
                    class="{{ 'collapse ' . (Request::segment(2) === 'categories' ? 'show' : '') }}"
                    aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Categories Settings</h6>
                        <a class="collapse-item" href={{ route('dashboard.categories') }}>All categories</a>
                        <a class="collapse-item" href={{ route('dashboard.categories.create') }}>Create Category</a>
                        <a class="collapse-item" href={{ route('dashboard.categories.edit') }}>Update Category</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider my-0" />
            <li class="{{ 'nav-item ' . (Request::segment(2) === 'users' ? 'active' : '') }}">
                <a class={{ 'nav-link ' . (Request::segment(2) === 'users' ? ' ' : 'collapsed') }} href="#"
                    data-toggle="collapse" data-target="#collapseFoor"
                    aria-expanded={{ Request::segment(2) === 'users' ? 'true' : 'false' }}
                    aria-controls="collapseFoor">
                    <i class="fas fa-solid fa-users"></i>
                    <span>Users</span>
                </a>
                <div id="collapseFoor" class="{{ 'collapse ' . (Request::segment(2) === 'users' ? 'show' : '') }}"
                    aria-labelledby="headingFoor" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Users Settings</h6>
                        <a class="collapse-item" href={{ route('dashboard.users') }}>All Users</a>
                        <a class="collapse-item" href={{ route('dashboard.users.create') }}>Create User</a>
                        <a class="collapse-item" href={{ route('dashboard.users.edit') }}>Update User</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider my-0" />
                                ...
                                >
                                    ...
                                    >
                                        <div class="dropdown-list-image mr-3">
                                            <img
                                                ...
                                                src={{ url("assets/dashboard/img/undraw_profile_1.svg") }}
                                                alt="..."
                                            />
                                            <div
                                    ...
                                    >
                                        <div class="dropdown-list-image mr-3">
                                            <img
                                                class="rounded-circle"
                                                src={{ url("assets/dashboard/img/undraw_profile_2.svg") }}
                                                alt="..."
                                            />
                                    ...
                                    >
                                        <div class="dropdown-list-image mr-3">
                                            <img
                                                class="rounded-circle"
                                                src={{ url("assets/dashboard/img/undraw_profile_3.svg") }}
                                                alt="..."
                                            />
                                            <div
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src={{ auth()->user()->picture ? asset('storage/' . auth()->user()->picture) : url('assets/site_images/avatar.png') }} />
                            </a>
