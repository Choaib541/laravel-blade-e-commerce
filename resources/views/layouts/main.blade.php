...
<head>
    ...
    <!-- Favicon -->
    <link href={{ url('assets/public/img/favicon.ico') }} rel="icon">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            @auth
                                <a href={{ route('dashboard') }} class="btn bg-primary text-dark">Dashboard</a>
                            @else
                                <a href={{ route('login') }} class="btn bg-primary text-dark">Login</a>
                                <a href={{ route('register') }} class="btn bg-primary text-dark">Register</a>
                            @endauth
            ...
            <div class="col">
                <div class="owl-carousel vendor-carousel">
                    <div class="bg-light p-4">
                        <img src={{ url('assets/public/img/vendor-1.jpg') }} alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src={{ url('assets/public/img/vendor-2.jpg') }} alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src={{ url('assets/public/img/vendor-3.jpg') }} alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src={{ url('assets/public/img/vendor-4.jpg') }} alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src={{ url('assets/public/img/vendor-5.jpg') }} alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src={{ url('assets/public/img/vendor-6.jpg') }} alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src={{ url('assets/public/img/vendor-7.jpg') }} alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src={{ url('assets/public/img/vendor-8.jpg') }} alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="assets/public/img/payments.png" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
