        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <form action={{ route('cart') }} method="POST" class="d-flex align-items-center mb-4 pt-2">
                        @csrf
                        <div class="input-group quantity mr-3" style="width: 200px;">
                            <input type="hidden" name="product_id" value={{ $product->id }}>
                            <input type="number" placeholder="Quanity..." value="1" min="1" name="quantity">
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        <img src={{ url('assets/public/img/user.jpg') }} alt="Image"
